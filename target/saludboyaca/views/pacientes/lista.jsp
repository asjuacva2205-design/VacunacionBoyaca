...
<div class="main-content">
    ...
    <c:if test="${not empty mensajeExito}">
        <div class="alerta-sb exito">
            <i class="fas fa-check-circle"></i> <c:out value="${mensajeExito}"/>
        </div>
    </c:if>
    <c:if test="${not empty mensajeError}">
        <div class="alerta-sb error">
            <i class="fas fa-exclamation-circle"></i> <c:out value="${mensajeError}"/>
        </div>
    </c:if>
    ...
    <div class="card-sb" style="padding:1rem 1.2rem;">
        <form method="get" action="${pageContext.request.contextPath}/citas"
            ...
            <input type="text" name="q" class="form-control"
                   placeholder="<fmt:message key='cita.paciente.placeholder'/>"
            ...
            <select name="estado" class="form-select" style="max-width:170px;">
                ...
                <option value="PENDIENTE"  ${param.estado=='PENDIENTE'  ? 'selected':''}><fmt:message key="estado.pendiente"/></option>
                <option value="CONFIRMADA" ${param.estado=='CONFIRMADA' ? 'selected':''}><fmt:message key="estado.confirmada"/></option>
                <option value="ATENDIDA"   ${param.estado=='ATENDIDA'   ? 'selected':''}><fmt:message key="estado.atendida"/></option>
                <option value="CANCELADA"  ${param.estado=='CANCELADA'  ? 'selected':''}><fmt:message key="estado.cancelada"/></option>
                <option value="RECHAZADA"  ${param.estado=='RECHAZADA'  ? 'selected':''}><fmt:message key="estado.rechazada"/></option>
            </select>
            ...
            <button type="submit" class="btn-saludboyaca" style="padding:.5rem 1rem;">
                <i class="fas fa-filter"></i> <fmt:message key="cita.buscar"/>
            </button>
    ...
    <div class="card-sb">
        <div class="card-sb-header">
            <h5>
                ...
                <fmt:message key="cita.titulo.lista"/>
        ...
        <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#1565C0;font-weight:700;font-family:'Space Grotesk',sans-serif;">
                                            <%-- ✅ CORRECTO: c:out para hora (sin padStart) --%>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="tabla-avatar">
                                                ${fn:substring(c.nombrePaciente, 0, 1)}
                                            </div>
                                            <span style="font-size:.9rem;">
                                                <c:out value="${c.nombrePaciente}"/>
                                            </span>
                                        </div>
                                    </td>
                                    <c:if test="${sessionScope.usuarioRol != 'MEDICO'}">
                                        <td style="font-size:.88rem;">
                                            <c:out value="${c.nombreMedico}"/>
                                        </td>
                                    </c:if>
                                    <td>
                                        <span class="badge"
                                    ...
                                    <td style="font-size:.85rem;color:var(--texto-suave);
                                    ...
                                    <td style="white-space:nowrap;text-align:right;">
                                        <button class="btn btn-sm btn-outline-primary"
                                                ...
                                                onclick="verCita(${c.id})" title="Ver detalle">
            ...
            <c:otherwise>
                <div class="text-center py-5" style="color:var(--texto-suave);">
                    ...
                    <p class="mb-2" style="font-size:.95rem;"><fmt:message key="cita.sin.resultados"/></p>
                    <button class="btn-saludboyaca" onclick="abrirModalCita()">
                        <i class="fas fa-plus"></i> <fmt:message key="cita.nueva"/>
                    </button>
                </div>
...
<!-- ══════════════════════════════════════════════════
     MODAL NUEVA CITA — WIZARD 3 PASOS
══════════════════════════════════════════════════ -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:2rem;">
                ...
                <div class="wizard-bar">
                    <div class="wstep active" id="ws1"><div class="num">1</div><fmt:message key="cita.especialidad"/></div>
                    <div class="wline" id="wl1"></div>
                    <div class="wstep" id="ws2"><div class="num">2</div><fmt:message key="cita.medico"/> &amp; <fmt:message key="cita.fecha"/></div>
                    <div class="wline" id="wl2"></div>
                    <div class="wstep" id="ws3"><div class="num">3</div><fmt:message key="cita.confirmar"/></div>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/citas"
                    ...
                    <div id="paso1Cita">
                        <c:if test="${sessionScope.usuarioRol != 'PACIENTE'}">
                            <div class="mb-4">
                                <label class="form-label fw-semibold">
                                    <i class="fas fa-user me-1" style="color:#1565C0;"></i>
                                ...
                                <select class="form-select" id="selPaciente"
                                    ...
                                    <option value=""><fmt:message key="cita.form.paciente"/></option>
                        ...
                        <p class="fw-semibold" style="color:var(--texto-titulos);margin-bottom:1rem;">
                            <i class="fas fa-stethoscope me-2" style="color:#1565C0;"></i>
                            <fmt:message key="cita.form.especialidad"/>
                        </p>
                        <div class="row g-3" id="gridEspecialidades">
                    ...
                    <div id="paso2Cita" style="display:none;">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <p class="fw-semibold" style="color:var(--texto-titulos);margin-bottom:.8rem;">
                                    <i class="fas fa-user-md me-2" style="color:#1565C0;"></i>
                            ...
                            <div class="col-md-6">
                                <p class="fw-semibold" style="color:var(--texto-titulos);margin-bottom:.8rem;">
                                    <i class="fas fa-calendar me-2" style="color:#1565C0;"></i>
                                    <fmt:message key="cita.fecha"/> y <fmt:message key="cita.hora"/>
                                </p>
                                <div class="cal-nav">
                                ...
                                <div id="slotsContainer" style="display:none;margin-top:1.2rem;">
                                    <p class="fw-semibold" style="font-size:.88rem;color:var(--texto-titulos);margin-bottom:.5rem;">
                                        <i class="fas fa-clock me-1" style="color:#1565C0;"></i>
                                    ...
                                    <div class="mt-3">
                                        <label class="form-label" style="font-size:.86rem;font-weight:600;">
                                            <i class="fas fa-comment me-1" style="color:#1565C0;"></i>
                                        ...
                                        <textarea name="motivo" class="form-control" rows="2"
                                                  ...
                                                  placeholder="<fmt:message key='cita.form.motivo.placeholder'/>"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="paso3Cita" style="display:none;">
                        <p class="fw-semibold" style="color:var(--texto-titulos);margin-bottom:1.2rem;">
                            <i class="fas fa-check-circle me-2" style="color:#00BFA5;"></i>
                            <fmt:message key="cita.confirmar"/>
                        </p>
                            ...
                            <div class="row g-0">
                                <div class="col-md-6">
                                    <div class="resumen-item">
                                        ...
                                        <div>
                                            <div class="resumen-label"><fmt:message key="cita.especialidad"/></div>
                                    ...
                                    <div class="resumen-item">
                                        ...
                                        <div>
                                            <div class="resumen-label"><fmt:message key="cita.medico"/></div>
                                ...
                                <div class="col-md-6">
                                    <div class="resumen-item">
                                        ...
                                        <div>
                                            <div class="resumen-label"><fmt:message key="cita.fecha"/></div>
                                    ...
                                    <div class="resumen-item">
                                        <div class="resumen-icon verde">🕐</div>
                                        <div>
                                            <div class="resumen-label"><fmt:message key="cita.hora"/></div>
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn-saludboyaca verde" id="btnConfirmar">
                                <i class="fas fa-calendar-check"></i> <fmt:message key="cita.form.confirmar"/>
                            </button>
                        </div>
                    </div>
                </form>
...
<script>
/* ══════════════════════════════════════════════════
   CITAS — lógica del wizard
   NOTA: padStart() aquí es JavaScript puro del navegador.
         NO está en EL de JSP — por eso funciona correctamente.
══════════════════════════════════════════════════ */
...
async function cargarMedicos(idEsp) {
    ...
    try {
        ...
        cont.innerHTML = medicos.map(m => `
            <div class="doctor-card" id="med-${m.id}"
                 onclick="selMedico(${m.id}, 'Dr. ${m.nombres} ${m.apellidos}')">
                <div class="doctor-avatar">${m.nombres.charAt(0)}</div>
                <div>
                    <div style="font-weight:700;font-size:.92rem;color:#0A1628;">Dr. ${m.nombres} ${m.apellidos}</div>
                    <div style="font-size:.8rem;color:#6B7C99;">📞 ${m.telefono || 'N/A'}</div>
                </div>
            </div>`).join('');
    } catch(e) {
...
/* ── Mini calendario ──
   ✅ padStart() aquí es JavaScript del navegador — funciona correctamente.
   ❌ El error era que el código Java en JSP intentaba llamar padStart()
      sobre una expresión EL de Java. Ahora todo el calendario es JS puro.
── */
function pad2(n) {
    // ✅ Equivalente a padStart(2,'0') pero más explícito
...
function renderCal() {
    ...
    for (let i = 0; i < start; i++) {
        ...
        v.className = 'mini-cal-day vacio';
        cal.appendChild(v);
    }
    ...
    for (let d = 1; d <= diasMes; d++) {
        ...
        // ✅ pad2() en JavaScript puro — NO en EL de JSP
        ...
        if (!esPasado && !esFinde) {
            el.onclick = () => selFecha(fechaStr, el);
        }
        cal.appendChild(el);
    }
}
...
async function cargarSlots() {
    ...
    try {
        ...
        if (!slots.length) {
            slotsDiv.innerHTML = '<div class="alerta-sb warn"><i class="fas fa-info-circle me-1"></i>Sin horarios disponibles para esta fecha.</div>';
            return;
        }

        // ✅ Generación limpia de slots — sin código mezclado
        let html = '';
        slots.forEach(g => {
            ...
            const title   = ocupado ? 'No disponible' : 'Seleccionar hora';
            html += '<span class="hora-slot ' + cls + '" onclick="' + click + '" title="' + title + '">' + txt + '</span>';
        });
...
function verCita(id) {
    ...
    fetch(`${CTX}/citas?accion=detalle&id=${id}`)
        .then(response => {
            if (!response.ok) throw new Error('Error en la respuesta');
            return response.json();
        })
        .then(c => {
            console.log("✅ Datos de cita recibidos:", c);

            let html = `
                <div class="row g-3">
                    <div class="col-md-4">
                        <div style="font-size:.8rem;color:#6B7C99;">Especialidad</div>
                        <div style="font-weight:600;">${c.nombreEspecialidad || '-'}</div>
                    </div>
                    <div class="col-md-4">
                        <div style="font-size:.8rem;color:#6B7C99;">Fecha</div>
                        <div style="font-weight:600;">${c.fechaCita || '-'}</div>
                    </div>
                    <div class="col-md-4">
                        <div style="font-size:.8rem;color:#6B7C99;">Hora</div>
                        <div style="font-weight:600;color:#1565C0;">${c.horaCita || '-'}</div>
                    </div>
                    
                    <div class="col-12">
                        <div style="font-size:.8rem;color:#6B7C99;">Motivo</div>
                        <div style="background:#EDF4FF;padding:.8rem;border-radius:10px;font-size:.9rem;">
                            ${c.motivo || '-'}
                        </div>
                    </div>`;
            ...
            if (c.observaciones && c.observaciones.trim() !== '') {
                html += `
                    <div class="col-12">
                        <div style="font-size:.8rem;color:#6B7C99;">Observaciones</div>
                        <div style="background:#EDF4FF;padding:.8rem;border-radius:10px;font-size:.9rem;">
                            ${c.observaciones}
                        </div>
                    </div>`;
            ...
            html += `
                    <div class="col-12 mt-2">
                        <span class="badge-estado badge-estado-${(c.estado || '').toLowerCase()}">
                            ${c.estado || '-'}
                        </span>
                    </div>
                </div>`;
...
function cambiarEstado(id, nuevoEstado, nombrePaciente) {
    Swal.fire({
        ...
        if (r.isConfirmed) {
            ...
            f.method = 'post';
            f.action = CTX + '/citas';
            [['accion','estado'],['id', id],['nuevoEstado', nuevoEstado]].forEach(([k,v]) => {
