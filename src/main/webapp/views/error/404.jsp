...
<div style="background:rgba(255,255,255,0.97);border-radius:20px;padding:3rem 2.5rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);">
  ...
  <h1 style="font-family:'Space Grotesk',sans-serif;font-size:4rem;font-weight:900;color:#0A1628;margin:0;">404</h1>
  <h2 style="font-size:1.3rem;color:#0A1628;margin:0.5rem 0 1rem;">Página no encontrada</h2>
  <p style="color:#6B7C99;font-size:0.95rem;">La página que buscas no existe o fue movida.</p>
