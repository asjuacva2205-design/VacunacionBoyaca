...
/**
 * EmailService — Servicio de correo electrónico SaludBoyacá
 * Genera correos HTML atractivos con temática de enfermería/vacunación.
 * Configura en WEB-INF/mail.properties: host, port, user, pass
 */
public class EmailService {
    ...
    public static class DatosCita {
        ...
        public DatosCita(String especialidad, String medico, String fecha,
            ...
            this.especialidad = especialidad; this.medico = medico;
            this.fecha = fecha; this.hora = hora;
            this.motivo = motivo; this.paciente = paciente;
        }
    }
    ...
    private static String buildCitaEmail(TipoEmail tipo, String nombrePaciente,
        ...
        switch (tipo) {
            case CITA_NUEVA:
                icono = "📅"; tipoLabel = "Nueva Cita Registrada"; tipoClase = "nueva";
                ...
                ctaTexto = "Ver mis citas"; ctaClase = ""; ctaUrl = APP_URL + "/citas";
                alerta = "⏳ Tu cita será confirmada en las próximas horas. Recuerda llegar 15 minutos antes.";
                alertaTipo = "info";
                break;
            case CITA_CONFIRMADA:
                icono = "✅"; tipoLabel = "Cita Confirmada"; tipoClase = "confirmada";
                ...
                ctaTexto = "Ver detalle de mi cita"; ctaClase = "verde"; ctaUrl = APP_URL + "/citas";
                alerta = "📌 Recuerda llevar tu documento de identidad y llegar 15 minutos antes de la cita.";
                alertaTipo = "success";
                break;
            case CITA_CANCELADA:
                icono = "❌"; tipoLabel = "Cita Cancelada"; tipoClase = "cancelada";
                ...
                ctaTexto = "Agendar nueva cita"; ctaClase = "rojo"; ctaUrl = APP_URL + "/citas";
                alerta = "🔄 Puedes agendar una nueva cita en cualquier momento desde el sistema.";
                alertaTipo = "warning";
                break;
            case CITA_RECHAZADA:
                icono = "⚠️"; tipoLabel = "Cita No Disponible"; tipoClase = "rechazada";
                ...
                break;
            default:
                icono = "📋"; tipoLabel = "Notificación"; tipoClase = "nueva";
                mensaje = "Tienes una notificación de SaludBoyacá.";
                ctaTexto = "Ir al sistema"; ctaClase = ""; ctaUrl = APP_URL;
                break;
        }
